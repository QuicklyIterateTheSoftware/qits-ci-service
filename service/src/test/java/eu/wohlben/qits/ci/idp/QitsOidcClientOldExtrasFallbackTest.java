 ...
 *
 * <p>The two old clients' env names carry the same id and secret (verified against {@code
 * ComposeTemplate.java}'s seed and dev blocks, 2026-09-13), so one fallback pair is enough; this
...
class QitsOidcClientOldExtrasFallbackTest {
  ...
  public static class OldExtrasOnly implements QuarkusTestProfile {
    ...
    public Map<String, String> getConfigOverrides() {
      ...
      return Map.of(
          "QUARKUS_OIDC_CLIENT_CLIENT_ID", "old-extras-qits-ci",
  ...
  void theQitsClientFallsBackToTheOldExtrasEnvNames() {
    assertEquals("old-extras-qits-ci", value("quarkus.oidc-client.qits.client-id"));
